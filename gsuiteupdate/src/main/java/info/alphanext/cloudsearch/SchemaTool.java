...
public class SchemaTool {
    ...
    public static void main(String[] argv) throws Exception {
      ...
      if (localSchema.get() == null) {
        throw new IllegalArgumentException("Missing gsuiteupdate.schema value in configuration");
      }
    ...
    static CloudSearch buildAuthorizedClient() throws Exception {
      ...
      return new CloudSearch.Builder(
          ...
          credential)
          .setApplicationName("GSuiteUpdate Connector")
          .build();
    }
     ...
     */
    // [START cloud_search_gsuiteupdate_update_schema]
    ...
    // [END cloud_search_gsuiteupdate_update_schema]
  }
